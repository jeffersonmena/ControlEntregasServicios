...
CREATE TABLE `estudiante` (
  ...
  KEY `DNI` (`DNI`),
  KEY `CodigoSeccion` (`CodigoSeccion`),
  CONSTRAINT `estudiante_ibfk_1` FOREIGN KEY (`DNI`) REFERENCES `encargado` (`DNI`),
...
CREATE TABLE `prestamodocente` (
  ...
  CONSTRAINT `prestamodocente_ibfk_2` FOREIGN KEY (`DNI`) REFERENCES `docente` (`DNI`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `prestamopersonal` (
  ...
  CONSTRAINT `prestamopersonal_ibfk_2` FOREIGN KEY (`DNI`) REFERENCES `personal` (`DNI`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
