    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="page-header">
              <h1 class="all-tittles">separar <small>cita</small></h1>
            </div>
            <p class="lead">
                Para realizar una cita llena los campos correspondientes a el usuario que realizara la cita
            </p>
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation" class="active"><a href="#loan1" aria-controls="home" role="tab" data-toggle="tab">Cita Abogado</a></li>
                <li role="presentation"><a href="#loan2" aria-controls="profile" role="tab" data-toggle="tab">Cita Juzgado</a></li>
                <li role="presentation"><a href="#loan3" aria-controls="messages" role="tab" data-toggle="tab">Cita Proceso</a></li>
                <li role="presentation"><a href="#loan4" aria-controls="messages" role="tab" data-toggle="tab">Consulta directorio</a></li>
            </ul>
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off">
                                ...
                                <p class="text-center">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Realizar cita</button>
                                </p>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de cédula del docente" name="userKey" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de cédula del personal administrativo" name="userKey" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Número de cédula</label>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanVisitor.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                               <?php
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de cédula del visitante" name="visitorDNI" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Número de cédula</label>
                                </div>
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de teléfono del visitante" name="visitorPhone" pattern="[0-9]{10,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente 10 números">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
