...
ALTER TABLE `docente`
  ADD PRIMARY KEY (`DNI`), ADD KEY `CodigoSeccion` (`CodigoSeccion`);

ALTER TABLE `encargado`
  ADD PRIMARY KEY (`DNI`);

ALTER TABLE `estudiante`
  ADD PRIMARY KEY (`NIE`), ADD KEY `DNI` (`DNI`), ADD KEY `CodigoSeccion` (`CodigoSeccion`);
...
ALTER TABLE `prestamodocente`
  ADD KEY `CodigoPrestamo` (`CodigoPrestamo`), ADD KEY `DNI` (`DNI`), ADD KEY `CodigoPrestamo_2` (`CodigoPrestamo`);

ALTER TABLE `prestamoestudiante`
  ADD KEY `CodigoPrestamo` (`CodigoPrestamo`), ADD KEY `NIE` (`NIE`);

ALTER TABLE `prestamopersonal`
  ADD KEY `CodigoPrestamo` (`CodigoPrestamo`), ADD KEY `DNI` (`DNI`);
...
ALTER TABLE `estudiante`
ADD CONSTRAINT `estudiante_ibfk_1` FOREIGN KEY (`DNI`) REFERENCES `encargado` (`DNI`),
...
ADD CONSTRAINT `prestamodocente_ibfk_2` FOREIGN KEY (`DNI`) REFERENCES `docente` (`DNI`);
...
ADD CONSTRAINT `prestamopersonal_ibfk_2` FOREIGN KEY (`DNI`) REFERENCES `personal` (`DNI`);
