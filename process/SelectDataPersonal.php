...
$selectPersonal=ejecutarSQL::consultar("SELECT * FROM personal WHERE DNI='".$codePersonal."'");
...
if(mysql_num_rows($selectPersonal)>=1){
    ...
    <input type="hidden" value="'.$dataPersonal["DNI"].'" name="personalDNI" >
    ...
    <div class="group-material">
        <input type="text" class="material-control tooltips-general" value="'.$dataPersonal["Telefono"].'" name="personalPhone" pattern="[0-9]{10,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente 10 números">
        <span class="highlight"></span>
        <span class="bar"></span>
