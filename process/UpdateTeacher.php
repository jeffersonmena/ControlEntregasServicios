...
if(consultasSQL::UpdateSQL("docente", "CodigoSeccion='$teachingSection',Nombre='$teachingName',Apellido='$teachingSurname',Telefono='$teachingPhone',Especialidad='$teachingSpecialty',Jornada='$teachingTime'", "DNI='".$teachingDNI."'")){
