    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Biblioteca ITSAE <small>Administración Usuarios</small></h1>
            </div>
        </div>
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 15%;">'.$dataP['DNI'].'</div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$dataP['DNI'].'" data-url="../process/SelectDataPersonal.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../process/DeletePersonal.php" method="post" data-type-form="delete" style="width: 9%;">
                                                <input value="'.$dataP['DNI'].'" type="hidden" name="primaryKey">
                            ...
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            <div class="div-table-cell" style="width: 6%;">'.$c.'</div>
                                            <div class="div-table-cell" style="width: 15%;">'.$data['DNI'].'</div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$data['DNI'].'" data-url="../process/SelectDataPersonal.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../process/DeletePersonal.php" method="post" data-type-form="delete" style="width: 9%;">
                                                <input value="'.$data['DNI'].'" type="hidden" name="primaryKey">
                                                <button type="submit" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button>
                                            </form>
                                        </div>
                                    </div>
