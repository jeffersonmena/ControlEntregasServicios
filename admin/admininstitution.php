    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><small>Administración Institución</small></h1>
            </div>
        </div>
                ...
                <form action="../process/AddInstitution.php" method="post" class="form_SRCB" data-type-form="save"  autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Teléfono de la institución" name="institutionPhone" required="" pattern="[0-9]{8,8}" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solo 8 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                ...
                <form action="../process/UpdateInstitution.php" method="post" class="form_SRCB" data-type-form="update"  autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                <input type="text" value="<?php echo $fila["Telefono"]; ?>" class="material-control tooltips-general" name="institutionPhone" required="" pattern="[0-9]{10,10}" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solo 10 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Teléfono</label>
                            </div>
