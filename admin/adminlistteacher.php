                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 15%;">'.$dataT['DNI'].'</div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$dataT['DNI'].'" data-url="../process/SelectDataTeacher.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../process/DeleteTeacher.php" method="post" data-type-form="delete" style="width: 9%;">
                                                <input value="'.$dataT['DNI'].'" type="hidden" name="primaryKey">
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$data['DNI'].'" data-url="../process/SelectDataTeacher.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../process/DeleteTeacher.php" method="post" data-type-form="delete" style="width: 9%;">
