    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">VITAL CADE <small>Administración Institución</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"><a href="adminsection.php">Departamentos</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los productos. Puedes actualizar o eliminar los datos de los prodcutos siempre y cuando no tenga productos asociados.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="admincategory.php">Nuevo producto</a></li>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de prodcutos</h2>
            <div class="div-table">
            ...
            <?php 
                ...
                if(mysql_num_rows($checkCategory)>0){
                    ...
                    echo '<br><br><br><h3 class="text-center all-tittles">No hay productos registradas en el sistema</h3><br><br>';
                }
          ...
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../process/UpdateCategory.php" method="post" data-type-form="update" autocomplete="off">
              <div class="modal-header">
                ...
                <h4 class="modal-title text-center all-tittles">Actualizar datos de producto</h4>
              </div>
