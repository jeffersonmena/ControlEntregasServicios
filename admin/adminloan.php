    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Biblioteca ITSAE <small>préstamos y reservaciones</small></h1>
            </div>
        </div>
                ...
                if(mysql_num_rows($checkAllLoans)>=1){
                    ...
                    while($data=mysql_fetch_array($checkAllLoans)){
                        ...
                        if(mysql_num_rows($checkLoanU1)>=1){
                            ...
                            $selectTeacherData=ejecutarSQL::consultar("SELECT * FROM docente WHERE DNI='".$dataU1['DNI']."'");
                        ...
                        if(mysql_num_rows($checkLoanU4)>=1){
                            ...
                            $selectPersonalData=ejecutarSQL::consultar("SELECT * FROM personal WHERE DNI='".$dataU4['DNI']."'");
