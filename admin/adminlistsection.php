...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="adminsection.php">Nuevo Departamento</a></li>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de Departamentos</h2>
            <div class="div-table">
            ...
            <?php 
                ...
                if($checktotal>0){
                    ...
                    echo '<br><br><br><h3 class="text-center all-tittles">No hay carreras registradas en el sistema</h3><br><br>';
                }
